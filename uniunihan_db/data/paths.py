...
# WinVNKey Hán-Việt reading databases (char -> Hán-Việt reading), converted to UTF-8
VI_WINVNKEY_FILES = [
    VI_RAW_DIR / "han-viet-thanh-son-le-3.04.txt",
    VI_RAW_DIR / "han-viet-hoc-d-ngo.txt",
    VI_RAW_DIR / "han-viet-trad-supplement-2.02.txt",
]
# Merged, normalized char -> Hán-Việt reading table (generated by data/vietnamese.py)
VI_READINGS_FILE = VI_DATA_DIR / "han_viet_readings.tsv"
